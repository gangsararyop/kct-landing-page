...
const ProductSection = () => {
  return (
    <div id="product-section" className="sm:max-w-8xl sm:px-6 lg:px-16 mx-auto">
      <div className="relative bg-[#293037] sm:rounded-[40px] lg:rounded-[60px] overflow-hidden p-6 sm:p-[56px_56px] md:p-[56px_56px] xl:p-[56px_96px]">
        <h3 className="text-sm sm:text-base lg:text-lg text-[#B4B4B4] underline mb-4 lg:mb-10 mx-auto lg:mx-0 w-fit">
          PRODUCTS
        </h3>
